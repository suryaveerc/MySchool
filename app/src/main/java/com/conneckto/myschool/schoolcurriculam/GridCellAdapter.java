...
public class GridCellAdapter extends BaseAdapter {
    ...
    private final String[] eventTypes = {"holidays","college"};
    private final String[] eventColorCodes = {"holidays","college"};
  ...
  //      CacheProvider.setHolidayMap(holidayMap);
  //      CacheProvider.setCollegeEventMap(collegeEventMap);
    ...
    private void getEventColor(Calendar cal) {
