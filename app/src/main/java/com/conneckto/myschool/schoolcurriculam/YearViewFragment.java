...
public class YearViewFragment extends Fragment implements View.OnClickListener {
    ...
    private int year;
    private Map<String, String> priorityEventMap;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        priorityEventMap = eventsDAO.fetchPriorityEventForEachMonth(year);
        ...
        // Initialised
        adapter = new YearViewGridCellAdapter(v.getContext(), R.id.calendar_month_gridcell, year, priorityEventMap);
